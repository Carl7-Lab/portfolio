...
export function HeroSection({ dict }: { dict: Dictionary }): JSX.Element {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[calc(100vh-70px)] text-center overflow-hidden">
      <span className="absolute top-20 left-10 w-20 h-20 bg-primary/20 rounded-full opacity-60 blur-3xl" />
      <span className="absolute top-40 right-20 w-16 h-16 bg-secondary/20 rounded-full opacity-40 blur-2xl" />
      <span className="absolute bottom-40 left-20 w-12 h-12 bg-accent/20 rounded-full opacity-40 blur-2xl" />
      <span className="absolute bottom-20 right-10 w-24 h-24 bg-primary/20 rounded-full opacity-40 blur-3xl" />

      <div className="absolute top-20 left-10 w-20 h-20 bg-gradient-to-r from-primary to-primary/80 rounded-full opacity-20 animate-bounce-slow" />
      <div className="absolute top-40 right-20 w-16 h-16 bg-gradient-to-r from-secondary to-secondary/80 rounded-full opacity-20 animate-pulse-slow" />
      <div className="absolute bottom-40 left-20 w-12 h-12 bg-gradient-to-r from-accent to-accent/80 rounded-full opacity-20 float" />
      <div className="absolute bottom-20 right-10 w-24 h-24 bg-gradient-to-r from-primary to-primary/80 rounded-full opacity-20 animate-bounce-slow" />
